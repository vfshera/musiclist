       ...
       <h2>Terms & Conditions</h2>
        ...
        <div v-show="previewStage === 1" class="basic-license " >
            ...
            <p class="lic-item">
             ...
             <p class="lic-item">
            	<strong>Delivery of the Beat:</strong>
                    <p class="item-points">
                         Licensor agrees to deliver the Beat as a high-quality <span class="font-weight-bold">MP3</span>, as such terms are understood in the music industry.
                    </p>
                    <p class="item-points">
                 ...
                 <strong>Use of the Beat:</strong>
                    ...
                    <p class="item-points">
                        This License grants Licensee a worldwide, non-exclusive license to use the Beat as incorporated in the New Song in the manners and for the purposes expressly provided for herein, subject to the sale restrictions, limitations and prohibited uses stated in this Agreement. Licensee acknowledges and agrees that any and all rights granted to Licensee in the Beat pursuant to this Agreement are on a <span class="font-weight-bold">NON-EXCLUSIVE</span> basis and Producer shall continue to license the Beat upon the same or similar terms and conditions as this Agreement to other potential third-party licensees.
                            ...
                            <p class="outlined-points">
                                Licensee <span class="font-weight-bold">MAY NOT</span> perform the song publicly for-profit performances, including but not limited to, at a live performance (i.e. concert, festival, nightclub etc.), on terrestrial or satellite radio, and/or on the internet via third-party streaming services (Spotify, YouTube, iTunes Radio etc.). The New Song <span class="font-weight-bold">MAY NOT</span> be played on terrestrial or satellite radio stations;
                            </p>
                            <p class="outlined-points">
                                The Licensee may use the New Song in synchronization with <span class="font-weight-bold">Zero (0)</span>  audiovisual work no longer than five (5) minutes in length (a “Video”). In the event that the New Song itself is longer than five (5) minutes in length, the Video may not play for longer than the length of the New Song. The Video may be broadcast on any television network and/or uploaded to the internet for digital streaming and/or free download by the public including but not limited to on YouTube and/or Vevo. Producer grants no other synchronization rights to Licensee;
                            </p>
                            <p class="outlined-points">
                                The Licensee may make the New Song available for sale in physical and/or digital form and sell <span class="font-weight-bold">10000</span> downloads/physical music products and are allowed <span class="font-weight-bold">10000</span> streams. The New Song may be available for sale as a single and/or included in a compilation of other songs bundled together by Licensee as an EP or a full-length Album. The New Song may be sold via digital retailers for permanent digital download in mp3 format and/or physical format, including compact disc and vinyl records. For clarity and avoidance of doubt, the Licensee does <span class="font-weight-bold">NOT</span> have the right to sell the Beat in the form that it was delivered to Licensee. The Licensee must create a New Song (or instrumental as detailed above) for its rights under this provision to a vest. Any sale of the Beat in its original form by Licensee shall be a material breach of this Agreement and the Licensee shall be liable to the Licensor for damages as provided hereunder.
                            </p>
                    </p>
                    <p class="item-points">
             ...
             <p class="lic-item">
                 <strong>Restrictions on the Use of the Beat:</strong> Licensee hereby agrees and acknowledges that it is expressly prohibited from taking any action(s) and from engaging in any use of the Beat or New Song in the manners, or for the purposes, set forth below:


                <p class="item-points">
                    The rights granted to Licensee are <span class="font-weight-bold">NON-TRANSFERABLE</span> and that Licensee may not transfer or assign any of its rights hereunder to any third-party;
                </p>

                <p class="item-points">
                    The Licensee shall not synchronize, or permit third parties to synchronize, the Beat or New Song with any audiovisual works  <span class="font-weight-bold">EXCEPT</span> as expressly provided for and pursuant to Paragraph 4(b)(iii) of this Agreement for use in one (1) Video. This restriction includes, but is not limited to, use of the Beat and/or New Song in television, commercials, film/movies, theatrical works, video games, and in any other form on the Internet which is not expressly permitted herein.
                </p>
            ...
            <p class="lic-item">
                ...
                <p class="item-points">
                     With respect to the publishing rights and ownership of the underlying composition embodied in the New Song, the Licensee, and the Producer hereby acknowledge and agree that the underlying composition shall be owned/split between them as follows:
                        <p class="outlined-points">
                             <span class="font-weight-bold">Licensee</span>, owns <span class="font-weight-bold">50%</span> of the writers share.
                        </p>
                        <p class="outlined-points">
            ...
            <p class="lic-item">
             ...
             <p class="lic-item">
                <strong>Warranties, Representations, and Indemnification:</strong>
                <p class="item-points">
        ...
        <div v-show="previewStage === 2"class="standard-license " >
            ...
            <p class="lic-item">
             ...
             <p class="lic-item">
            	<strong>Delivery of the Beat:</strong>
                    <p class="item-points">
                         Licensor agrees to deliver the Beat as a high-quality <span class="font-weight-bold">MP3 & WAV</span>, as such terms are understood in the music industry.
                    </p>
                    <p class="item-points">
                        Licensor shall use commercially reasonable efforts to deliver the Beat to Licensee immediately after payment of the License Fee is made. Licensee will receive the Beat via email, to the email address Licensee provided to Licensor.
                    </p>
        ...
        <div v-show="previewStage === 3" class="popular-premium-license" >
            ...
            <p class="lic-item">
             ...
             <p class="lic-item">
            	<strong>Delivery of the Beat:</strong>
                    <p class="item-points">
                         Licensor agrees to deliver the Beat as a high-quality <span class="font-weight-bold">MP3 , WAV & TRACKSTEMS</span>, as such terms are understood in the music industry.
                    </p>
                    <p class="item-points">
                        Licensor shall use commercially reasonable efforts to deliver the Beat to Licensee immediately after payment of the License Fee is made. Licensee will receive the Beat via email, to the email address Licensee provided to Licensor.
                    </p>
                 ...
                 <strong>Use of the Beat:</strong>
                    ...
                    <p class="item-points">
                        This License grants Licensee a worldwide, non-exclusive license to use the Beat as incorporated in the New Song in the manners and for the purposes expressly provided for herein, subject to the sale restrictions, limitations and prohibited uses stated in this Agreement. Licensee acknowledges and agrees that any and all rights granted to Licensee in the Beat pursuant to this Agreement are on a <span class="font-weight-bold">NON-EXCLUSIVE</span> basis and Producer shall continue to license the Beat upon the same or similar terms and conditions as this Agreement to other potential third-party licensees.
                            ...
                            <p class="outlined-points">
                                Licensee <span class="font-weight-bold">MAY</span> perform the song publicly for-profit performances, including but not limited to, at a live performance (i.e. concert, festival, nightclub etc.), on terrestrial or satellite radio, and/or on the internet via third-party streaming services (Spotify, YouTube, iTunes Radio etc.). The New Song may be played on <span class="font-weight-bold">Unlimited</span> terrestrial or satellite radio stations;
                            </p>
                            <p class="outlined-points">
                                The Licensee <span class="font-weight-bold">MAY</span> use the New Song in synchronization with <span class="font-weight-bold">One (1)</span>  audiovisual work no longer than five (5) minutes in length (a “Video”). In the event that the New Song itself is longer than five (5) minutes in length, the Video may not play for longer than the length of the New Song. The Video may be broadcast on any television network and/or uploaded to the internet for digital streaming and/or free download by the public including but not limited to on YouTube and/or Vevo. Producer grants no other synchronization rights to Licensee;
                            </p>
                            <p class="outlined-points">
                                The Licensee <span class="font-weight-bold">MAY</span> make the New Song available for sale in physical and/or digital form and sell <span class="font-weight-bold">100000</span> downloads/physical music products and are allowed <span class="font-weight-bold">100000</span> streams. The New Song may be available for sale as a single and/or included in a compilation of other songs bundled together by Licensee as an EP or a full-length Album. The New Song may be sold via digital retailers for permanent digital download in mp3 format and/or physical format, including compact disc and vinyl records. For clarity and avoidance of doubt, the Licensee does NOT have the right to sell the Beat in the form that it was delivered to Licensee. The Licensee must create a New Song (or instrumental as detailed above) for its rights under this provision to a vest. Any sale of the Beat in its original form by Licensee shall be a material breach of this Agreement and the Licensee shall be liable to the Licensor for damages as provided hereunder.
                            </p>
                    </p>
                    <p class="item-points">
                         Subject to the Licensee’s compliance with the terms and conditions of this Agreement, Licensee shall not be required to account or pay to Producer any royalties, fees, or monies paid to or collected by the Licensee (expressly excluding mechanical royalties), or which would otherwise be payable to Producer in connection with the use/exploitation of the New Song as set forth in this Agreement.
                 ...
                 <strong>Use of the Beat:</strong>
                    ...
                    <p class="item-points">
                        This License grants Licensee a worldwide, non-exclusive license to use the Beat as incorporated in the New Song in the manners and for the purposes expressly provided for herein, subject to the sale restrictions, limitations and prohibited uses stated in this Agreement. Licensee acknowledges and agrees that any and all rights granted to Licensee in the Beat pursuant to this Agreement are on a <span class="font-weight-bold">NON-EXCLUSIVE</span> basis and Producer shall continue to license the Beat upon the same or similar terms and conditions as this Agreement to other potential third-party licensees.
                            ...
                            <p class="outlined-points">
                                Licensee <span class="font-weight-bold">MAY</span> perform the song publicly for-profit performances and for an <span class="font-weight-bold">Unlimited</span> non-profit performances, including but not limited to, at a live performance (i.e. concert, festival, nightclub etc.), on terrestrial or satellite radio, and/or on the internet via third-party streaming services (Spotify, YouTube, iTunes Radio etc.). The New Song may be played on <span class="font-weight-bold">Unlimited</span> terrestrial or satellite radio stations;
                            </p>
                            <p class="outlined-points">
                                The Licensee <span class="font-weight-bold">MAY</span> use the New Song in synchronization with <span class="font-weight-bold">Unlimited</span>  audiovisual work no longer than five (5) minutes in length (a “Video”). In the event that the New Song itself is longer than five (5) minutes in length, the Video may not play for longer than the length of the New Song. The Video may be broadcast on any television network and/or uploaded to the internet for digital streaming and/or free download by the public including but not limited to on YouTube and/or Vevo. Producer grants no other synchronization rights to Licensee;
                            </p>
                            <p class="outlined-points">
                                The Licensee <span class="font-weight-bold">MAY</span> make the New Song available for sale in physical and/or digital form and sell <span class="font-weight-bold">Unlimited</span> downloads/physical music products and are allowed <span class="font-weight-bold">Unlimited</span> monetized audio streams , <span class="font-weight-bold">Unlimited</span> monetized video streams , <span class="font-weight-bold">Unlimited</span> non-monetized video streams and are allowed <span class="font-weight-bold">Unlimited</span> free downloads. The New Song may be available for sale as a single and/or included in a compilation of other songs bundled together by Licensee as an EP or a full-length Album. The New Song may be sold via digital retailers for permanent digital download in mp3 format and/or physical format, including compact disc and vinyl records. For clarity and avoidance of doubt, the Licensee does NOT have the right to sell the Beat in the form that it was delivered to Licensee. The Licensee must create a New Song (or instrumental as detailed above) for its rights under this provision to a vest. Any sale of the Beat in its original form by Licensee shall be a material breach of this Agreement and the Licensee shall be liable to the Licensor for damages as provided hereunder.
                            </p>
                    </p>
                    <p class="item-points">
                         Subject to the Licensee’s compliance with the terms and conditions of this Agreement, Licensee shall not be required to account or pay to Producer any royalties, fees, or monies paid to or collected by the Licensee (expressly excluding mechanical royalties), or which would otherwise be payable to Producer in connection with the use/exploitation of the New Song as set forth in this Agreement.
