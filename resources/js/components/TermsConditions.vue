    ...
    <div class="terms-conditions">
       <h3>Terms & Conditions</h3>
        ...
        <p class="standard-license">
            <p class="intro">
        This Non-Exclusive Standard Lease License Agreement (the “Agreement”), having been made on and effective as of Mon, 08 Mar 2021 06:17:34 -0500 (the “Effective Date”) by and between <span class="font-weight-bold">Producer</span> p/k/a  <span class="font-weight-bold">{{ producerName }}</span> (the “Producer” or “Licensor”); and Licensee residing at [N/A] (“You” or “Licensee”), sets forth the terms and conditions of the Licensee’s use, and the rights granted in, the Producer’s instrumental music file entitled The Beat Title (Contract Preview Only) (the “Beat”) in consideration for Licensee’s payment of $29.95 (the “License Fee”), on a so-called “Standard Lease” basis.
            ...
            <p class="lic-item">
                ...
                <p class="item-points">
                     With respect to the publishing rights and ownership of the underlying composition embodied in the New Song, the Licensee, and the Producer hereby acknowledge and agree that the underlying composition shall be owned/split between them as follows:
                        ...
                        <p class="outlined-points">
                            <span class="font-weight-bold"> Producer ({{ producerName }}) </span>, owns 50% of the writers share.
                        </p>
                            <p class="outline-bullets">
...
<style scoped>
    ...
    .lic-item , .item-points , .outlined-points , .outline-bullets , .lic-item strong , .intro {
        width: 100ch;
        display: block;
    }
